...
// PSX MemCard Status Read/Write LED Pins
const byte PIN_LED_READ  = A4; // A4---[470R]---(+LED-)---GND
const byte PIN_LED_WRITE = A5; // A5---[470R]---(+LED-)---GND

// PSX MemCard Pin assignments
#if defined (__AVR_ATmega32U4__)
#define AttPin    2           // Att (SS)
#define CmndPin   16          // MOSI aka Command
#define DataPin   14          // MISO aka Data // 14---[4.7K]---3.3V
#define ClockPin  15          // SCK
#define AckPin    12          // Ack
#endif

// PSX to USB Pin assignments
const byte PIN_PSX_ATT1 = 10; // D10
const byte PIN_PSX_CMD1 = 16; // MOSI
const byte PIN_PSX_DAT1 = 14; // MISO // 14---[4.7K]---3.3V
const byte PIN_PSX_CLK1 = 15; // SCK
...
PsxControllerBitBang<PIN_PSX_ATT1, PIN_PSX_CMD1, PIN_PSX_DAT1, PIN_PSX_CLK1> psx1;
...
void enableHardwareSPI() {
  digitalWrite(PIN_PSX_ATT1, HIGH); // Force Gamepad CS HIGH to prevent bus noise
  SPI.begin();
...
void PinSetup(){
  ...
  pinMode(PIN_PSX_ATT1, OUTPUT);
  digitalWrite(AttPin, HIGH);
  digitalWrite(PIN_PSX_ATT1, HIGH);
